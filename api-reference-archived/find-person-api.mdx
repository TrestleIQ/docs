...
description: "Find Person API provides the person's details, including demographics, all current and historical addresses, and relatives and associates to this person."
api: "GET /3.1/person"
playground: "none"
---
