---
title: "Real Contact API 1.0 (Archived)"
...
<ResponseField name="phone.line_type" type="string or null">
  ...
  `Other` - Line type is unclear Enum: <Badge>Landline</Badge> <Badge>Mobile</Badge> <Badge>FixedVOIP</Badge> <Badge>NonFixedVOIP</Badge> <Badge>Premium</Badge> <Badge>TollFree</Badge> <Badge>Voicemail</Badge> <Badge>Other</Badge>
</ResponseField>
