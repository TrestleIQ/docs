...
<ParamField query="street_line_1" type="string">
  ...
  than 1000 characters. **Example:** `street_line_1=100 Main St`
</ParamField>
...
<ParamField query="country_code" type="string (ISO-3166-2)">
  ...
  Cannot be longer than 100 characters. **Example:** `country_code=US`
</ParamField>
...
<ResponseField name="delivery_point" type="string or null (DeliveryPoint)">
  The type of the delivery point of the address. Enum: <Badge>SingleUnit</Badge>
  <Badge>MultiUnit</Badge> <Badge>POBox</Badge> <Badge>PartialAddress</Badge>
</ResponseField>
...
<ResponseField name="current_residents" type="object[]">
  ...
  <Expandable title="owner object">
    ...
    <ResponseField name="link_to_phone_start_date" type="string or null (LinkToPhoneStartDate)">
...
<ResponseField name="last_sale_date" type="string or null (YYYY-MM-DD)">
  The date of the last sale of the property. Available for US addresses only.
</ResponseField>

<ResponseField name="total_value" type="number or null">
...
<ResponseField name="owners" type="object[]">
  ...
  <Expandable title="owner object">
    ...
    <ResponseField name="alternate_names" type="string or null">
      Alternate names of the person associated with the phone.
    </ResponseField>
...
<ResponseField name="associated_addresses" type="object[]">
...
<ResponseField name="warnings" type="string[]">
  ...
  include - <Badge>Invalid Input</Badge>,
  <Badge>International number. Not authorized</Badge>, or
