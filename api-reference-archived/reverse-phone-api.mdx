...
description: "Reverse Phone API validates a phone number and provides phone metadata, owner name and demographics, current and historical addresses, relatives and associated people."
api: "GET /3.1/phone"
playground: "none"
---
