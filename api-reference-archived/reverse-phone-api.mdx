...
description: "Reverse Phone API validates a phone number and provides phone metadata, owner name and demographics, current and historical addresses, relatives and associated people, and additional phone numbers."
api: "GET /3.1/phone"
playground: "none"
---
...
## Reverse Phone API 3.1

```http
GET https://api.trestleiq.com/3.1/phone?phone=[insert_phone_number]
```
...
<ResponseField name="associated_people" type="object[]">
  TThe list of related and associated people to person or business in belongs_to array.
  ...
  <ResponseField name="id" type="string or null <Person.<uuid>>">
    ...
    <ResponseField name="relation" type="string or null">
      Relation of the associated person. Enum: <Badge>Household</Badge> <Badge>PotentialOwner</Badge>
    </ResponseField>
...
<ResponseField name="warnings" type="string[]">
  ...
  include - <Badge>Invalid Input</Badge>, <Badge>International number. Not authorized</Badge>, or <Badge>Missing Input</Badge>.
</ResponseField>
