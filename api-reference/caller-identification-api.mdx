...
<ResponseField name="line_type" type="string or null">
  ...
  Enum:<Badge>Landline</Badge> <Badge>Mobile</Badge> <Badge>FixedVOIP</Badge> <Badge>Premium</Badge> <Badge>TollFree</Badge> <Badge>Voicemail </Badge> <Badge>Other</Badge>\<Badge\>NonFixedVOIP\</Badge\>
</ResponseField>
