...
<ResponseField name="belongs_to" type="object[]">
  ...
  <Expandable title="belongs_to object">
    ...
    <ResponseField name="type" type="string">
      ...
      <br />Enum: <Badge>Business</Badge>, <Badge>Person</Badge>
    </ResponseField>
    ...
    <ResponseField name="lat_long" type="object">
      ...
      <Expandable title="lat_long object">
        ...
        <ResponseField name="accuracy" type="string or null">
          The accuracy of the geographical location. Enum: <Badge>Country</Badge> <Badge>State</Badge> <Badge>City</Badge><br /><Badge>PostalCode</Badge> <Badge /> <Badge>Street</Badge> <Badge>RoofTop</Badge>
        </ResponseField>
      </Expandable>
    </ResponseField>
...
<ResponseField name="warnings" type="string[]">
  Warnings returned as part of the response, if applicable.<br /><br />Enum: <Badge>Invalid Input</Badge> <Badge>International number. Not authorized</Badge> <Badge>Missing Input</Badge>
</ResponseField>
