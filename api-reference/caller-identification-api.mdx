...
<ResponseField name="line_type" type="string or null">
  ...
  `Other` - Line type is unclear Enum:
  <br /> <Badge>Landline</Badge> <Badge>Mobile</Badge> <Badge>FixedVOIP</Badge> <Badge>
    NonFixedVOIP
  </Badge> <Badge>Premium</Badge> <Badge>TollFree</Badge> <Badge>
    Voicemail
  ...
  <Expandable title="belongs_to object">
   <ResponseField name="id" type="string or null <Person.<uuid>>">
    ...
    <ResponseField name="type" type="string">
      ...
      <br />Enum: <Badge color="gray">Business</Badge>, <Badge color="gray">Person</Badge>
    </ResponseField>
