---
title: "Phone Feedback API Documentation"
sidebarTitle: "Phone Feedback API"
description: "Phone Feedback API Documentation: Submit connected/disconnected status and right-party contact confirmation for dialed numbers via a POST request."
