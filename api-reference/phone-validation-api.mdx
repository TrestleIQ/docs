---
title: "Phone Validation API Documentation"
sidebarTitle: "Phone Validation API"
description: "Phone Validation API Documentation: Integrate the phone_intel endpoint to return carrier, line type, prepaid status, and Phone Activity Score for any number."
