...
<ResponseField name="owners" type="object[]">
  ...
  <Expandable title="owner object">
    ...
    <ResponseField name="current_addresses" type="object[]">
      A list of unique current locations associated with the Person or Business in the belongs\_to array.
      ...
      <Expandable title="address object">
        ...
        <ResponseField name="location_type" type="string or null">
          The type of the location. Enum: <Badge>Country</Badge> <Badge>N</Badge> <Badge>City</Badge>  <Badge>N</Badge> <Badge>ZipPlus4</Badge> <Badge>Address</Badge>
        </ResponseField>
