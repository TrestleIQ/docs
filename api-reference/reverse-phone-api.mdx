...
<ResponseField name="line_type" type="string or null">
  ...
  Enum: <Badge>Landline</Badge> <Badge>Mobile</Badge> <Badge>FixedVOIP</Badge> <Badge>NonFixedVOIP</Badge> <Badge>Premium</Badge> <Badge>TollFree</Badge> <Badge>Voicemail</Badge>\
  <Badge>Other</Badge>
</ResponseField>
...
<ResponseField name="owners" type="object[]">
  ...
  <Expandable title="owner object">
    ...
    <ResponseField name="type" type="string">
      ...
      - Company: The legal entity is a company. Enum: <Badge>Business</Badge> <Badge>Person</Badge>
    </ResponseField>
...
<ResponseField name="warnings" type="string[]">
  Warnings returned as part of the response, if applicable. The possible values include - <Badge>Invalid Input</Badge>," " <Badge>International number. Not authorized</Badge>, or" " <Badge>Missing Input</Badge>.
</ResponseField>
