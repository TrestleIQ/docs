...
<ResponseField name="owners" type="object[]">
  ...
  <Expandable title="owner object">
    ...
    <ResponseField name="type" type="string">
      ...
      - Business: The legal entity is a company. Enum: <Badge>Business</Badge> <Badge>Person</Badge>
    </ResponseField>
    ...
    <ResponseField name="current_addresses" type="object[]">
      ...
      <Expandable title="address object">
        ...
        <ResponseField name="location_type" type="string or null">
          The type of the location. Enum: <Badge>Country</Badge> <Badge>Neighborhood</Badge> <Badge>City</Badge> <Badge>N</Badge> <Badge>Neighborhood</Badge> <Badge>ZipPlus4</Badge> <Badge>Address</Badge>
        </ResponseField>
