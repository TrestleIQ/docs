---
title: "Smart CNAM API Documentation"
sidebarTitle: "Smart CNAM API"
description: "Smart CNAM API Documentation: Validate a phone number and return the person or business name for caller ID and CNAM lookup use cases."
api: "GET /3.1/cnam"
playground: none
---
